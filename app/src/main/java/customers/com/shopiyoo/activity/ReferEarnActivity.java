    ...
    public void OnInviteFrdClick(View view) {
        if (!txtcode.getText().toString().equals("code")) {
            try {
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT, "I think you'll Love KHUBA FRESH."
                        + "\nThey deliver high Quality Vegetables, Fruits and Groceries right to your Doorstep."
                        + "\nYour refer code is - " + txtcode.getText().toString()
                        + "\nClick the Link below to Download their app."
                        + "\n " + "https://play.google.com/store/apps/details?id=dhdeveloper.com.khubafresh");
