...
import customers.com.bigbis.activity.DrawerActivity;
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                try {
                    ...
                    for (int j = 0; j < pricearray.length(); j++) {
                        ...
                        Log.e("Product Details", obj.toString());
                    ...
                    productArrayList.add(new Product(jsonObject.getString(Constant.ID), jsonObject.getString(Constant.NAME), jsonObject.getString(Constant.SLUG), jsonObject.getString(Constant.SUC_CATE_ID), jsonObject.getString(Constant.IMAGE), jsonObject.getJSONArray(Constant.OTHER_IMAGES).toString(), jsonObject.getString(Constant.DESCRIPTION), jsonObject.getString(Constant.STATUS), jsonObject.getString(Constant.DATE_ADDED), jsonObject.getString(Constant.CATEGORY_ID), priceVariations, jsonObject.getString("indicator"), jsonObject.getString(Constant.MAX_PURCHASE_QTY)));
